              ...
              <div className="divide-y divide-gray-100 dark:divide-slate-700">
                {buses.map((bus, index) => (
                  ...
                  >
                    ...
                    {/* Col 4: Driver */}
                    <div className="bg-gray-50 dark:bg-slate-700/50 p-2 rounded-lg border border-gray-100 dark:border-slate-600 transition-colors">
