    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex flex-col items-center justify-center p-6 transition-colors duration-300">
      ...
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 animate-in zoom-in duration-500">
        ...
        <div
          ...
          className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-10 rounded-3xl text-center cursor-pointer hover:border-indigo-500 hover:ring-4 ring-indigo-500/10 transition-all group shadow-xl"
        >
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8 font-medium">
            Book your bus seats and manage tickets
          </p>
        ...
        <div
          ...
          className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-10 rounded-3xl text-center cursor-pointer hover:border-red-500 hover:ring-4 ring-red-500/10 transition-all group shadow-xl"
        >
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8 font-medium">
            Manage fleet and verify boarding tickets
          </p>
      ...
      <button
        onClick={() => navigate('/')}
        className="mt-12 text-slate-400 hover:text-indigo-500 font-bold text-sm transition-colors"
      >
        ← Back to Home
      </button>
    </div>
